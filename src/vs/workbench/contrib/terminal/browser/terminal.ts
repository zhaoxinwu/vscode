...
export interface ITerminalEditorService extends ITerminalInstanceHost, ITerminalFindHost {
	...
	getOrCreateResource(instance: ITerminalInstance | DeserializedTerminalEditorInput | URI): URI | TerminalEditorInput;
	...
	resolveResource(resource: URI): TerminalEditorInput | undefined;
}
