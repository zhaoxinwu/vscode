...
registerAction2(class extends Action2 {
	...
	async run(accessor: ServicesAccessor, showOptions?: number | { viewColumn?: number, preserveFocus?: boolean }, resource?: URI, id?: string): Promise<{ notebookUri: URI, inputUri: URI; notebookEditorId?: string }> {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: { value: localize('interactive.focusOutput', "Focus Cell Output"), original: 'Focus Last Cell Output' },
			category: 'Interactive',
			f1: false
		});
	}
